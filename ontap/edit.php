...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!isset($errors)) {
        $sql = "UPDATE products SET product_name='$product_name', image='$image', price=$price, quantity=$quantity, description='$description', cate_id=$cate_id WHERE id=$id";
